...
-(void)loadStaticData{
    titles = [[NSArray alloc]initWithObjects:@"Heads Up! - Warner Bros.",@ "Minecraft – Pocket Edition - Mojang",@ "Blek - Denis Mikan",@ "Afterlight - Simon Filip",@ "Geometry Dash - Robert Topala",@ "Justin.tv - Twitch Interactive, Inc.",nil];
